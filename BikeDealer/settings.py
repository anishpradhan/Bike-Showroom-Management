...
SECRET_KEY = 'bf=is8scg92nlhxwf4)vggq8+3k#ik#i6ql*=$x_d(cd7v5)gr'
...
WSGI_APPLICATION = 'BikeDealer.wsgi.application'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'BikeDealer/static'),
]
...
DJANGORESIZED_DEFAULT_SIZE = [1080, 768]
